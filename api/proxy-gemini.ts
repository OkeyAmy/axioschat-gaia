...
export default async function handler(req: NextRequest) {
  ...
  try {
    ...
    console.log(`Received API key in proxy-gemini: ${maskedKey}`);
    ...
    console.log('Proxying request to Gaia Network Qwen API with model:', requestData.model);
    ...
    console.error('Error in gaia-proxy:', error);
